...
<template>
  <AppLayout>
    <div class="px-6 py-12 sm:px-12 lg:px-20">
      <!-- Page header -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold" style="color: #0F110C;">Nouveau Composant</h1>
        <p class="mt-2" style="color: #0F110C; opacity: 0.7;">Ajoutez un nouveau composant a votre inventaire</p>
      </div>
        ...
        <div class="rounded-xl shadow-lg p-8" style="background-color: white;">
          <form @submit.prevent="submit">
            ...
            <div class="flex gap-4">
              ...
              >
                {{ form.processing ? 'Creation...' : '&#9989; Creer le composant' }}
              </button>
              <Link
                href="/components"
